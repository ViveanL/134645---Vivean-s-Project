                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name">
                                    ...
                                    <option value="Stanbic" @if(old('bank_name') == 'Stanbic')selected="selected"@endif>STANBIC</option>
                                    <option value="DTB" @if(old('bank_name') == 'DTB')selected="selected"@endif>DTB</option>
