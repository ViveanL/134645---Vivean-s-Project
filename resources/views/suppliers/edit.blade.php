                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name">
                                    ...
                                    <option value="Barclays" @if(old('bank_name', $supplier->bank_name) == 'Barclays')selected="selected"@endif>BARCLAYS</option>
                                    <option value="ABSA" @if(old('bank_name', $supplier->bank_name) == 'ABSA')selected="selected"@endif>ABSA</option>
                                    <option value="Stanbic" @if(old('bank_name', $supplier->bank_name) == 'Stanbic')selected="selected"@endif>STANBIC</option>
                                    <option value="DTB" @if(old('bank_name', $supplier->bank_name) == 'DTB')selected="selected"@endif>DTB</option>
                                    <option value="NCBA" @if(old('bank_name', $supplier->bank_name) == 'NCBA')selected="selected"@endif>NCBA</option>
                                </select>
                                @error('bank_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
